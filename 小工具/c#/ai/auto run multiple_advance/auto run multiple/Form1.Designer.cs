namespace hahaha
{
    partial class form_auto_run_multiple
    {
        ...
        private void InitializeComponent()
        {
            ...
            panel2.Controls.Add(button_process_cpu);
            ...
            // button_process_cpu
            // 
            button_process_cpu.Location = new Point(104, 201);
            button_process_cpu.Name = "button_process_cpu";
            button_process_cpu.Size = new Size(80, 60);
            button_process_cpu.TabIndex = 19;
            button_process_cpu.Text = "CPU設定";
            button_process_cpu.UseVisualStyleBackColor = true;
            button_process_cpu.Click += button_process_cpu_Click;
            // 
            // button_kill_process
            // 
        ...
        private Button button_process_cpu;
